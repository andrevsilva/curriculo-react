...
const ModalLink = () => {
    ...
    return (
        <div>
            <Button onClick={modalHtml}><img src={html} /></Button>
            <Modal isOpen={modal} toggle={modalHtml}>
                <ModalHeader><img src={htmlgif} /></ModalHeader>
                <ModalBody>
...
const ModalLinkCss = () => {
    ...
    return (
        <div>
            <Button onClick={modalCss}><img src={css} /></Button>
            <Modal isOpen={modal} toggle={modalCss}>
                <ModalHeader><img src={cssgif} /></ModalHeader>
...
const ModalLinkJs = () => {
    ...
    return (
        <div>
            <Button onClick={modaljS}><img src={js} /></Button>
            <Modal isOpen={modal} toggle={modaljS}>
                <ModalHeader><img src={jsgif} /></ModalHeader>
...
const ModalLinkBootstratp = () => {
    ...
    return (
        <div>
            <Button onClick={modalBootstratp}><img src={bootstrap} /></Button>
            <Modal isOpen={modal} toggle={modalBootstratp}>
                <ModalHeader><img src={bootstrapgif} /></ModalHeader>
...
const ModalLinkSass = () => {
    ...
    return (
        <div>
            <Button onClick={modalSass}><img src={sass} /></Button>
            <Modal isOpen={modal} toggle={modalSass}>
                <ModalHeader><img src={sass} /></ModalHeader>
...
const ModalLinkjQuery = () => {
    ...
    return (
        <div>
            <Button onClick={modaljQuery}><img src={jquery} /></Button>
            <Modal isOpen={modal} toggle={modaljQuery}>
                <ModalHeader><img src={jquery} /></ModalHeader>
...
const ModalLinkReact = () => {
    ...
    return (
        <div>
            <Button onClick={modalReact}><img src={reactimg} /></Button>
            <Modal isOpen={modal} toggle={modalReact}>
                <ModalHeader><img src={reactgif} /></ModalHeader>
                <ModalBody>
...
const ModalLinkVue = () => {
    ...
    return (
        <div>
            <Button onClick={modalVue}><img src={vuejs} /></Button>
            <Modal isOpen={modal} toggle={modalVue}>
                <ModalHeader><img src={vuegif} /></ModalHeader>
...
const ModalLinkPhp = () => {
    ...
    return (
        <div>
            <Button onClick={modalPhp}><img src={php} /></Button>
            <Modal isOpen={modal} toggle={modalPhp}>
                <ModalHeader><img src={phpgif} /></ModalHeader>
...
const ModalLinkCode = () => {
    ...
    return (
        <div>
            <Button onClick={modalCode}><img src={codeigniter} /></Button>
            <Modal isOpen={modal} toggle={modalCode}>
                <ModalHeader><img src={codeigniter} /></ModalHeader>
...
const ModalLinkMySql = () => {
    ...
    return (
        <div>
            <Button onClick={modalMySql}><img src={mysql} /></Button>
            <Modal isOpen={modal} toggle={modalMySql}>
                <ModalHeader><img src={mysql} /></ModalHeader>
                <ModalBody>
