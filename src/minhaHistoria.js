...
export const minhaHistoria = () =>(

    <div>
        <div className="header">
            <ul className="menu">
                <li><Link className="resetar" to="">Home</Link></li>
                <li><Link className="resetar" to="minhaHistoria">Minha Historia</Link></li>
                <li><Link className="resetar" to="skills">Skills</Link></li>
            </ul>
        </div>
        ...
        <div className="title">
            ...
            <div className="efeitoMq">
                <Typing>
                    <span>Me conheça por trás dos códigos</span>
                </Typing>
            </div>
